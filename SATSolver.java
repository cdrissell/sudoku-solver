...
public class SATSolver {
	...
	/**
	 * Returns literals that satisfy the given formula, if the formula is
	 * satisfiable.
	 * 
	 * @param cnfFormulaFileName Path name of the file containing the formula
	 * @return An array of literal values denoting a satisfying assignment when one
	 *         exists; null for unsatisfiable formulae.
	 ...
	 * @throws Exception
	 */
	public static int[] solve(String cnfFormulaFileName)
			throws FileNotFoundException, ParseFormatException, IOException, ContradictionException, TimeoutException {
